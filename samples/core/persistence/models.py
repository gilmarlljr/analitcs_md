...
class User(BaseModel):
    ...
    username = peewee.CharField(max_length=200, primary_key=True)
    display_name = peewee.CharField(max_length=200, null=True)
...
class Embendding(BaseModel):
    ...
    characters_count = peewee.IntegerField(null=True)
    words_count = peewee.IntegerField(null=True)
    stopwords_count = peewee.IntegerField(null=True)
    numerics_count = peewee.IntegerField(null=True)
    uppercase_count = peewee.IntegerField(null=True)
    average_word_length = peewee.FloatField(null=True)
    content_cleaned = peewee.TextField(null=True)
    empath = peewee.TextField(null=True)
    word_to_vec = peewee.TextField(null=True)
